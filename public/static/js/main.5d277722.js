/*! For license information please see main.5d277722.js.LICENSE.txt */
!(function () {
  'use strict';
  var e = {
      463: function (e, n, t) {
        ...
        function Vl() {
          if (!Al && null !== jl) {
            ...
            try {
              ...
              throw (null !== jl && (jl = jl.slice(e + 1)), qe(Je, Vl), l);
            } finally {
              (kn = n), (Al = !1);
            }
          }
          ...
          if (null !== (o = e.memoizedState) && null !== (r = o.dehydrated))
            return (function (e, n, t, r, l, o, u) {
              ...
              if (((i = 0 !== (u & e.childLanes)), ku || i)) {
                ...
                return ms(), Uu(e, n, u, (r = fu(Error(a(421)))));
              }
              return '$?' === l.data
                ? ((n.flags |= 128),
                  (n.child = e.child),
        ...
        function cs(e) {
          ...
          try {
            ...
            (kn = r), (Pi.transition = t), 0 === (6 & (Ni = n)) && Vl();
          }
        }
        function fs() {
          (Oi = Ri.current), Cl(Ri);
        ...
        function Cs(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            zi === e &&
              (Li & t) === t &&
              (4 === Mi ||
              (3 === Mi && (130023424 & Li) === Li && 500 > Ge() - Bi)
                ? ds(e, 0)
                : (ji |= t)),
            rs(e, n);
        }
  ...
  (t.m = e),
    ...
    (t.u = function (e) {
      return 'static/js/' + e + '.7c42db31.chunk.js';
    }),
    ...
    (function () {
      ...
      var n = function (n, r) {
        ...
        r = (self.webpackChunkmovie_app = self.webpackChunkmovie_app || []);
    ...
    (function () {
      ...
      var p = t(184),
        h = function (e) {
          ...
          return (0, p.jsx)('div', {
            ...
            children: (0, p.jsxs)('div', {
              className: 'extra-detail-movie-card',
              children: [
                (0, p.jsx)('h2', { children: n.name }),
                (0, p.jsx)('p', { children: n.year }),
                (0, p.jsxs)('p', {
                  children: [
                    'Directed by ',
                    (0, p.jsx)('i', { children: n.director }),
                  ],
                }),
                (0, p.jsxs)('p', {
                  children: [
                    'Acted by ',
                    (0, p.jsx)('i', { children: n.cast }),
                  ],
                }),
                (0, p.jsxs)('p', {
                  children: [
                    'Langugae of movie is \xa0',
                    (0, p.jsx)('i', { children: n.language }),
                  ],
                }),
                (0, p.jsx)('p', { children: n.duration }),
                (0, p.jsxs)('h3', { children: ['IMDB ', n.imdb] }),
                (0, p.jsx)('button', { onClick: t, children: 'X' }),
              ],
            }),
          });
        },
        ...
        v = (function (e) {
          ...
          function t(e) {
            ...
            return (
              r(this, t),
              ((l = n.call(this, e)).state = { isClicked: !1 }),
              (l.openPopup = l.openPopup.bind(c(l))),
              (l.closePopup = l.closePopup.bind(c(l))),
              l
            );
          }
          return (
            a(t, [
              ...
              },
              {
                key: 'render',
                value: function () {
                  var e = this.props.movie;
                  return this.state.isClicked
                    ? (0, p.jsx)(h, { movie: e, onClick: this.closePopup })
                    : (0, p.jsx)(m, { movie: e, onClick: this.openPopup });
                },
              },
            ]),
            t
        ...
        y = (function (e) {
          ...
          function t(e) {
            ...
            return (
              r(this, t),
              ((l = n.call(this, e)).handleChange = l.handleChange.bind(c(l))),
              l
            );
          }
          return (
            a(t, [
              {
                key: 'handleChange',
                value: function (e) {
                  var n = this.props.movies.filter(function (n) {
                    var t = n.name,
                      r = g(t),
                      l = g(e.target.value);
                    return r.includes(l);
                  });
                  this.props.handleSearch(n);
                },
              },
              {
                key: 'render',
        ...
        b = (function (e) {
          ...
          function t(e) {
            ...
            return (
              r(this, t),
              ((l = n.call(this, e)).state = {
                filteredMovies: e.movies,
                toBeLoaded: 10,
              }),
              (l.loadMore = l.loadMore.bind(c(l))),
              (l.handleSearch = l.handleSearch.bind(c(l))),
              l
            );
          }
          return (
            a(t, [
              {
                ...
                value: function () {
                  this.setState(function (e) {
                    return { toBeLoaded: e.toBeLoaded + 10 };
                  });
                },
              },
              {
                ...
                value: function (e) {
                  this.setState(function () {
                    return { filteredMovies: e };
                  });
                },
              },
              {
                key: 'moviesNeedToBeLoaded',
                value: function () {
                  return this.state.filteredMovies.slice(
                    0,
                    this.state.toBeLoaded
                  );
                },
              },
              {
                key: 'render',
                value: function () {
                  var e = this.moviesNeedToBeLoaded().map(function (e) {
                    return (0, p.jsx)(v, { movie: e }, e.id);
                  });
                  return (0, p.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, p.jsx)('div', { className: 'movies', children: e }),
                      (0, p.jsx)('button', {
            ...
            a(t, [
              {
                ...
                value: function () {
                  ...
                  fetch('/all')
                    ...
                    .then(function (n) {
                      e.setState(function () {
                        return { loading: !1, movies: n };
                      });
                    })
                    .catch(function (n) {
                      e.setState({ messgae: n });
                    });
                },
              },
              {
                ...
                value: function () {
                  return this.state.loading
                    ? (0, p.jsx)('p', { children: this.state.message })
                    : (0, p.jsx)(b, { movies: this.state.movies });
                },
              },
            ]),
            t
      ...
      n
        ...
        .render((0, p.jsx)(e.StrictMode, { children: (0, p.jsx)(w, {}) })),
        S();
    })();
})();
//# sourceMappingURL=main.5d277722.js.map
